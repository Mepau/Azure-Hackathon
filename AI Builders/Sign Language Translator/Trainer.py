...
from TimingLibs import timeSince
from LanguageBuilder import Lang, readLangs
from AttnDecoderRNN import AttnDecoderRNN
from EvaluateLibs import evaluate, evaluateRandomly, tensorsFromPair
import time
...
torch.save({
            'Enconder_state_dict': encoder1.state_dict(),
